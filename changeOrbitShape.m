function [D_v1, D_v2, df, Dt] = changeOrbitShape(ai, ei, i, OM, om_i, th_i, af, ef, om_f,th_f, mu)
...
stepTh = pi/180;
th = 0:stepTh:th_i;
[r,v] = kep2car(ai,ei,i,OM,om_i,0:stepTh:th_i,mu);

    r_norm1 = norm(kep2car(ai,ei,i,OM,om,th_i,mu));
    r_norm2 = norm(kep2car(af,ef,i,OM,om,th_f,mu));

    D_v1 = sqrt(2*mu*(1/r_norm1-1/(2*af)))-sqrt(2*mu*(1/r_norm1-1/(2*ai)));
    ...
    D_v2 = sqrt(2*mu*(1/r_norm2-1/(2*af)))-sqrt(2*mu*(1/r_norm2-1/(2*at)));
